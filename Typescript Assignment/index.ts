...
let mountainNames: string[] = ["Mount Everest", "K2", "Kangchenjunga", "Lhotse", "Makalu"];
let riverNames: string[] = ["Nile", "Amazon", "Yangtze", "Mississippi", "Ganges"];
let countryNames: string[] = ["Egypt", "Brazil", "Pakistan", "United States", "India"];
let cityNames: string[] = ["Cairo", "Sao Paulo", "Islamabad", "New York", "Delhi"];
let languageNames: string[] = ["Arabic", "Portuguese", "English", "Spanish", "Hindi"];
